  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 py-10 px-4">
      ...
      <div className="text-center space-y-4">
        ...
        <h1
          className={`h1-bold ${isSuccess ? "text-green-600" : "text-amber-600"}`}
        >
          ...
          <Card className="border-blue-100 bg-blue-50/30 overflow-hidden">
            <CardHeader className="bg-blue-50/50">
              <CardTitle className="flex items-center gap-2 text-blue-800 text-xl">
                ...
                {isSuccess ? "Digital Delivery" : "Next Steps"}
              </CardTitle>
            </CardHeader>
              ...
              {isSuccess ? (
                <>
                  <p className="text-sm text-blue-700/80 leading-relaxed font-medium">
                    Your digital license keys are being processed. Since this is
                    a digital purchase, please keep the following in mind:
                  </p>
                  <ul className="space-y-4">
                    <li className="flex gap-4 text-sm items-start">
                      ...
                      <span className="text-blue-900/80 pt-1">
                        The license key will be delivered{" "}
                        <strong>digitally</strong> to your email address.
                      </span>
                    </li>
                    <li className="flex gap-4 text-sm items-start">
                      <div className="bg-blue-100 p-2 rounded-full flex-shrink-0">
                ...
                <>
                  <p className="text-sm text-blue-700/80 leading-relaxed font-medium">
                    To complete your order, please proceed to the payment page.
                    Once payment is confirmed, your digital products will be
                    delivered.
                  </p>
                  <div className="pt-2">
                    <Button asChild className="w-full md:w-auto">
                      <Link href={`/order/${id}`}>Complete Payment</Link>
                    </Button>
                  </div>
                </>
              )}
        ...
        <div className="space-y-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-semibold leading-none break-all">
                    {order.user.email}
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-3 pt-2">
            {!isSuccess && (
              <Button
                asChild
                className="w-full justify-between h-12 text-base font-semibold shadow-md group"
                variant="default"
              >
                <Link href={`/order/${id}`}>
                  Proceed to Payment
            ...
            <Button
              asChild
              className="w-full justify-between h-12 text-base font-semibold group"
              variant="outline"
            >
              <Link href={`/order/${id}`}>
                View Order Details
