      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="text-sm leading-7 text-zinc-600 dark:text-zinc-400">
            ...
            Products are delivered electronically via email and no physical
            goods are shipped.
          </p>
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="text-sm leading-7 text-zinc-600 dark:text-zinc-400">
            Due to the nature of digital products, refunds may be limited once
            a license key has been delivered. Refund eligibility is determined
            in accordance with our Refund Policy and applicable consumer laws.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-3">
          ...
          <div className="rounded-lg border border-zinc-200 p-4 text-xs leading-6 text-zinc-500 dark:border-zinc-800 dark:text-zinc-400">
            Windows, Microsoft Office, Microsoft, and related trademarks are
            the property of Microsoft Corporation. Any referenced trademarks are
